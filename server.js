...
app.post('/api/paint-services/quotes', (req, res) => {
  ...
  const newQuote = {
    ...
    paintQualityName: body.paintQualityName || 'Gama Alta (Poliéster y Tintas)',
    paintQualityTier: body.paintQualityTier || 'Gama Alta',
    varnishQuality: body.varnishQuality || 'alta_a',
    varnishQualityTier: body.varnishQualityTier || 'Gama Alta A',
    varnishBrand: body.varnishBrand || 'DuPont',
    varnishName: body.varnishName || 'DuPont (Gama Alta A)',
