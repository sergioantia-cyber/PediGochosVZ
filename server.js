...
app.post('/api/paint-services/quotes', (req, res) => {
  ...
  const newQuote = {
    ...
    paintQuality: body.paintQuality || 'alta',
    paintQualityName: body.paintQualityName || 'Poliéster y Tintas • Gama Alta (Full Recomendado)',
    paintQualityTier: body.paintQualityTier || 'Gama Alta (Full Recomendado)',
    varnishQuality: body.varnishQuality || 'alta_a',
    varnishQualityTier: body.varnishQualityTier || 'Gama Alta A (Full Recomendado)',
    varnishBrand: body.varnishBrand || 'DuPont',
    varnishName: body.varnishName || 'DuPont • Gama Alta A (Full Recomendado)',
    polishingMaterials: Array.isArray(body.polishingMaterials) ? body.polishingMaterials : ['Lijas 1500 2000 3000 5000 3M', 'Robin 3M', 'Symplex Piraña', 'Cerámica'],
    polishingTier: body.polishingTier || 'Solo Gama Alta (3M, Symplex Piraña & Cerámica)',
