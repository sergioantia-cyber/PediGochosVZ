...
if (fs.existsSync(buildGradlePath)) {
  ...
  gradleContent = gradleContent.replace(/applicationId\s+["'][^"']+["']/, 'applicationId "com.pedigochos.admin"');
  fs.writeFileSync(buildGradlePath, gradleContent, 'utf8');
  console.log('📱 ApplicationId configurado como independiente: com.pedigochos.admin');
}
...
const apkDestDesktop = path.join(userDesktop, 'PediGochos-Duenio.apk');
